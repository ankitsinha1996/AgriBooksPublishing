...
public class AddAuthor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String author_phoneNo = request.getParameter("author_phoneNo");
        
        Author author = new Author();

        author.setAuthorId(authorId);
        author.setAuthor_name(author_name);
        author.setAuthor_email(author_email);
        author.setAuthor_phoneNo(author_phoneNo);
        
        boolean reply = AuthorDao.addAuthor(author);
